...
const RegisterPage = () => {
  ...
  /* ── shared input style — matched to LoginPage ── */
  const inp = (hasErr) => ({
  ...
  /* ── section heading — matched to LoginPage accent colours ── */
  ...
  const isDisabled = loading || Object.keys(validationErrors).length > 0;
    ...
    <div style={{ minHeight: '100vh', background: '#F8FAF9', fontFamily: "'Poppins','Inter','Helvetica Neue',sans-serif" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Input focus — matches LoginPage exactly */
        .reg-inp:focus {
        ...
        /* Button hovers — matches LoginPage */
        .submit-btn:hover:not(:disabled) { background: linear-gradient(135deg,#0f2419,#1a3d2b) !important; }
      ...
      {/* ── Navbar — dark green gradient matching LoginPage ── */}
      <nav style={{
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        {/* ── Form card — border + shadow matched to LoginPage card ── */}
        <div style={{
          background: '#fff',
          border: '1px solid rgba(82,183,136,0.18)',
          borderRadius: 20, padding: '36px',
          boxShadow: '0 4px 24px rgba(26,61,43,0.1)',
        }}>

          {/* Accent bar at top of card — matches LoginPage card header bar */}
          <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            {sectionHeading(<Building2 size={14} color="#86efac" />, 'Business Information')}

            {/* Business Name — full width (business type removed) */}
            <div>
            ...
            {/* Contact Email + Phone — two-column grid (restored) */}
            ...
            {/* ══ Account Owner ══ */}
            {sectionHeading(<User size={14} color="#86efac" />, 'Account Owner')}
            ...
            {/* ══ Security ══ */}
            {sectionHeading(<Lock size={14} color="#86efac" />, 'Security')}
            ...
            {/* ── Actions — gradient button matching LoginPage ── */}
        ...
        {/* ── Footer note — matched to LoginPage footer note style ── */}
        <div style={{
