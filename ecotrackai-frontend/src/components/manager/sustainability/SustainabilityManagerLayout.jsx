...
const SustainabilityManagerLayout = ({ children, currentPage, user }) => {
  ...
  const navItems = [
    { icon: LayoutDashboard, label: 'Dashboard',             path: '/sustainability-manager' },
    { icon: History,         label: 'Verification History',  path: '/sustainability-manager/history' },
  ];
      ...
      <aside className="w-64 bg-white border-r border-gray-200 p-6 flex flex-col shadow-sm">
        <div className="flex items-center gap-3 mb-10">
          ...
          <div>
            ...
            <p className="text-xs text-green-600 font-semibold">Sustainability Manager</p>
          </div>
        </div>
